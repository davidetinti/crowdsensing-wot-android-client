...
import com.example.wot_servient.mqtt.utils.MqttProtocolException;
...
public class LAMqttProtocolSettings {
	...
	public LAMqttProtocolSettings(Config config) {
	...
	LAMqttProtocolSettings(String broker, String clientId, String username, String password) {
		this.broker = broker;
