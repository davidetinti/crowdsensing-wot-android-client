 ...
 */
public class LAMqttProtocolClient implements ProtocolClient {

	private static final String TAG = "LAMqttProtocolClient";
	...
	public LAMqttProtocolClient(Pair<MqttProtocolSettings, MqttAndroidClient> mqttClientPair) {
		this(mqttClientPair, new HashMap<>());
	}

	LAMqttProtocolClient(Pair<MqttProtocolSettings, MqttAndroidClient> mqttClientPair, Map<String, Observable<Content>> topicSubjects) {
