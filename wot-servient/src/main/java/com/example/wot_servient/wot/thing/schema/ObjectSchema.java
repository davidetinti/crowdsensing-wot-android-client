...
public class ObjectSchema extends AbstractDataSchema<Map> {
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private final Map<String, DataSchema> properties;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private final List<String> required;

	public ObjectSchema() {
		this(new HashMap<>(), new ArrayList<>());
	}

	public ObjectSchema(Map<String, DataSchema> properties, List<String> required) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getProperties(), that.getProperties()) && Objects.equals(getRequired(), that.getRequired());
	}
