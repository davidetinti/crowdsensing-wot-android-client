...
public class ThingFilter {
	 ...
	 * local {@link com.example.wot_servient.wot.Servient}, {@link DiscoveryMethod#DIRECTORY} searches in the Thing
	 * Directory defined in {@link #url}. {@link DiscoveryMethod#ANY} uses the discovery mechanisms
	 * provided by all {@link com.example.wot_servient.wot.binding.ProtocolClient} implementations to consider all
	 * available Things.
	 *
	 * @param method
	 * @return
	...
	public boolean equals(Object o) {
		...
		return method == that.method && Objects.equals(url, that.url) && Objects.equals(query, that.query);
	}

	@Override
	public String toString() {
		return "ThingFilter{" + "method=" + method + ", url=" + url + ", query=" + query + '}';
	}
}
