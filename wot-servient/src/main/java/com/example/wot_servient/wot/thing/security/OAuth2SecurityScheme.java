...
public class OAuth2SecurityScheme implements SecurityScheme {
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String flow;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String token;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String refresh;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private List<String> scopes;
	...
	public String toString() {
		return "OAuth2SecurityScheme{" + "authorization='" + authorization + '\'' + ", flow='" + flow + '\'' + ", token='" + token + '\'' + ", refresh='" + refresh + '\'' + ", scopes=" + scopes + '}';
	}
}
