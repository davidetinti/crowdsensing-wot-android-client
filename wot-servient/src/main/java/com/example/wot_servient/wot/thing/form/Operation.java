...
public enum Operation {
	// properties
	READ_PROPERTY("readproperty"), WRITE_PROPERTY("writeproperty"), OBSERVE_PROPERTY("observeproperty"), UNOBSERVE_PROPERTY("unobserveproperty"), READ_ALL_PROPERTIES("readallproperty"), READ_MULTIPLE_PROPERTIES("readmultipleproperty"), // events
	SUBSCRIBE_EVENT("subscribeevent"), UNSUBSCRIBE_EVENT("unsubscribeevent"), // actions
