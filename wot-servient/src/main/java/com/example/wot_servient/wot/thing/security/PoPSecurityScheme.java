...
public class PoPSecurityScheme implements SecurityScheme {
	...
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String in;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String name;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String format;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String authorization;
	@JsonInclude(JsonInclude.Include.NON_EMPTY) private String alg;

	public PoPSecurityScheme(String in, String name, String format, String authorization, String alg) {
		this.in = in;
		this.name = name;
		this.format = format;
	...
	public String toString() {
		return "PoPSecurityScheme{" + "in='" + in + '\'' + ", name='" + name + '\'' + ", format='" + format + '\'' + ", authorization='" + authorization + '\'' + ", alg='" + alg + '\'' + '}';
	}
}
