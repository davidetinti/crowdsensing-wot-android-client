...
abstract class AbstractInteractionRoute extends AbstractRoute {
    ...
    private boolean checkCredentials(String securityScheme, String id, Request request) {
        ...
        Log.d("AbstractInteractionRoute", "HttpServer checking credentials for " + id);
        ...
        if (securityScheme.equals("Basic")) {
            ...
            if (header != null) {
                ...
                if (split.length >= 2) {
                    ...
                    Log.w("AbstractInteractionRoute", "Unable to decode username and password from authorization header");
                    return false;
                }
            }
            else {
            ...
            Log.w("AbstractInteractionRoute", "Unknown security scheme provided. Decline access.");
            return false;
        }
    }
